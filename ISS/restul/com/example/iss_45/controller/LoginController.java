...
import com.example.iss_45.domain.User;
...
public class LoginController {
    ...
    void loginClick(MouseEvent event) throws IOException {
        ...
        if(user instanceof Client){
            ...
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/com/example/iss_45/ClientView.fxml"));
            ...
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/com/example/iss_45/LibrarianView.fxml"));
            Parent root = fxmlLoader.load();
