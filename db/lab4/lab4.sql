...
-------------------------------CREARE TABELE-------------------------------
--  o tabel? având un câmp ca ?i cheie primar? ?i nici o cheie str?in?
CREATE TABLE Instrumente(
	id INT PRIMARY KEY IDENTITY(1,1),
	denumire VARCHAR(100),
)

-- o tabel? având un câmp ca ?i cheie primar? ?i cel pu?in o cheie str?in?
...
-- o tabel? având dou? câmpuri ca ?i cheie primar?
...
-- primul View: un view ce con?ine o comand? SELECT pe o tabel?
...
-- al doilea View: un view ce con?ine o comand? SELECT aplicat? pe cel pu?in dou? tabele
...
-- al treilea View: un view ce con?ine o comand? SELECT aplicat? pe cel pu?in dou? tabele ?i având o clauz? GROUP BY.
