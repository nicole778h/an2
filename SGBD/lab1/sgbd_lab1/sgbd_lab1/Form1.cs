...
{
    public partial class Bysh : Form
    {//conexiunea + adaptoarele de date pt extragere
        string connectionString = @"Server=DESKTOP-MUDMF6L\SQLEXPRESS;Database=bysh;
        ...
        //reimprospateaza datele in tabel
        ...
        //retin info despre randul selectat
        ...
        private void btnAdaugaAngajat_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Introduceți un nume valid pentru angajat!");
            }
            else if (rolSelectat == 0)
            {
