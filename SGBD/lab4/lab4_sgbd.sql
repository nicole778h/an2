...
--------------------------------------------------------------- Dirty Reads ---------------------------------------------------------
	--1--
	BEGIN TRANSACTION 
	UPDATE Roluri SET salar=4400 WHERE rol='casier';
...
-------------------------------------------------------- Non-Repeatable Reads ------------------------------------------------------------
    ...
    UPDATE Roluri SET salar=4400 WHERE rol='casier';
	INSERT INTO IstoricTranzactii(actiune, data_executiei,mesaj) VALUES('casier updated', CURRENT_TIMESTAMP, 'Delay for casier update')
    COMMIT TRANSACTION
	INSERT INTO IstoricTranzactii(actiune, data_executiei,mesaj) VALUES('casier updated', CURRENT_TIMESTAMP, 'Update rollback ended')
...
SET TRANSACTION ISOLATION LEVEL SERIALIZABLE;
BEGIN TRAN;
UPDATE Roluri SET salar=3500 WHERE rol='casier';
WAITFOR DELAY '00:00:05';
...
WAITFOR DELAY '00:00:05';
UPDATE Roluri SET salar=3000 WHERE rol='casier';
COMMIT TRAN;
...
AS
    BEGIN
        BEGIN TRANSACTION
        UPDATE Roluri SET salar=2000 WHERE rol='manager';
        WAITFOR DELAY '00:00:10'
...
AS
    BEGIN
        ...
        BEGIN TRANSACTION
        UPDATE Roluri SET salar=3000 WHERE rol='manager';
        WAITFOR DELAY '00:00:10'
